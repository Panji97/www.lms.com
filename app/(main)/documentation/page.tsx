...
`}</code>
            ...
            <p>
              ...
              groups the pages with full page content such as landing page or a
              login page.
            </p>
...
`}
            ...
            <p>
              The pages that are using the layout elements need to be defined
              under the{' '}
...
`}
            ...
            <p>
              Only the pages that are using config sidebar wihout layout
              elements need to be defined under the{' '}
              <span className="text-primary font-medium">
                app/{'(full-page)'}/
              </span>{' '}
              folder. Those pages use the{' '}
    ...
    const [layoutConfig, setLayoutConfig] = useState({
        ...
        scale: 14                               //size of the body font size to scale the whole application
            ...
            <p>
              ...
              open <b>_variables.scss</b> file under layout folder. Saving the
